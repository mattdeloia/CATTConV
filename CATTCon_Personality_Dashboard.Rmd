...
##### Education:  Highest degree achieved by percentage of Northrop Grumman Cybersecuirty Professionals.  Of the `r n_CyberPro$n` cybersecurity professionals, `r round(df_ed3$n, 2)*100` percent have degrees in Computer Science or related fields. 
...
df_sd <- dfcluster3 %>% group_by(Category) %>% summarise(sd=sd(Score)) %>% mutate(cluster_sd=if_else(sd>.09, "High", "Low"))
